...
**eMascot Hổ Gin** là người bạn đồng hành trung tâm trong suốt hành trình cảm xúc. Biểu cảm của Gin thay đổi sinh động theo trạng thái cảm xúc của học sinh — mỗi lần check-in, Gin phản chiếu lại đúng tâm trạng mà học sinh đang trải qua.

**eMonster** là đối trọng của Gin — hình tượng hóa các vấn đề sức khỏe tâm thần thường gặp thành các "Quái vật". Học sinh làm trắc nghiệm, thực hiện các nhiệm vụ EQ để "thu phục" eMonster — chuyển hóa thành eMascot. Đây là cách Emotico giữ cho hành trình chăm sóc sức khỏe tinh thần trở nên thú vị và bền vững.
